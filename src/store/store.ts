...
import { fetchFilmsFx, loginFx, fetchPromoFilmFx, fetchSimilarFilmsFx, fetchUserFx, logoutFx, fetchReviewsFx } from "./api";
...
export const $reviews = createStore<ReviewType[]>([]).on(fetchReviewsFx.doneData, (_, reviews) => reviews)
